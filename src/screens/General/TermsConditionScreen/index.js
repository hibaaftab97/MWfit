    ...
    return (
      <View style={styles.mainView}>
        <View style={styles.contentViewStyle}>
          ...
          <TextWrapper style={styles.textHeadingViewStyle}>Using “MW FIT.”</TextWrapper>
          ...
          <TextWrapper style={styles.descriptionContentView} numberOfLines={20}>
            ...
            “MW FIT” grants you limited access and use to the website and users must not download, modify, or copy any part of our website including information and content. The user agrees not to collect or store any product information or resell, copy, distribute or sell any part of our website or software.
            To use our site and services you are required to create an account with “MW FIT” and provide certain personal information such as name, email address, and other contact details.
          ...
          <TextWrapper style={styles.descriptionContentView} numberOfLines={20}>
            ...
            All content including but not limited to pictures, videos, and text are copyrighted by “MW FIT” unless stated. You may not copy, reproduce, distribute, or store any material on our website unless given express written permission by us.
          </TextWrapper>
          ...
          <TextWrapper style={styles.descriptionContentView} numberOfLines={50}>
            “MW FIT” services and all information, materials, content, products and other services included on or otherwise made available to you through the “MW FIT” services are provided by us on an ‘as is’ and ‘as available basis unless other specified.
            “MW FIT” makes no representations or warranties of any kind, express or implied including but not limited to the content, materials, products, software and other services made available to you through “MW FIT” unless otherwise specified in writing.
            ...
            “MW FIT” or any of its affiliates will not be liable for any damages of any kind arising from the use of our services or from any material, products, content or other services made available to you.
          ...
          <TextWrapper style={styles.descriptionContentView} numberOfLines={50}>
            ...
            The user agrees to be bound by the “MW FIT” privacy policy which is available here.
          </TextWrapper>

          <TextWrapper style={styles.textHeadingViewStyle}>Force Majeure.</TextWrapper>

          <TextWrapper style={styles.descriptionContentView} numberOfLines={50}>
            “MW FIT” is not liable for any failure or delay in performance or its obligations which is due to the result of any act, event, terrorism act, acts of God, governmental regulations, war, riots, fire, pandemic, flood or anything else which is beyond our control.
          </TextWrapper>
